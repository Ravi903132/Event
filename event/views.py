...
def admin_dashboard_view(request):
    ...
    return render(request,'event/admin_dashboard.html',context=dict)
...
def admin_view_customer_view(request):
    ...
    return render(request,'event/admin_view_customer.html',{'customers':customers})
...
def update_customer_view(request,pk):
    ...
    return render(request,'event/update_customer.html',context=mydict)
...
def admin_category_view(request):
    return render(request,'event/admin_category.html')
...
def admin_add_category_view(request):
    ...
    return render(request,'event/admin_add_category.html',{'categoryForm':categoryForm})

def admin_view_category_view(request):
    categories = models.Category.objects.all()
    return render(request,'event/admin_view_category.html',{'categories':categories})

def admin_delete_category_view(request):
    categories = models.Category.objects.all()
    return render(request,'event/admin_delete_category.html',{'categories':categories})
...
def admin_update_category_view(request):
    categories = models.Category.objects.all()
    return render(request,'event/admin_update_category.html',{'categories':categories})
...
def update_category_view(request,pk):
    ...
    return render(request,'event/update_category.html',{'categoryForm':categoryForm})
...
def admin_question_view(request):
    ...
    return render(request,'event/admin_question.html',{'questions':questions})
...
def update_question_view(request,pk):
    ...
    return render(request,'event/update_question.html',{'questionForm':questionForm})
...
def aboutus_view(request):
    return render(request,'event/aboutus.html')
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            return render(request, 'event/contactussuccess.html')
    return render(request, 'event/contactus.html', {'form':sub})
